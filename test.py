...
if __name__ == "__main__":
    ...
    model = g.train(model, train_dl, test_dl, device, loss_fn=loss_fn, lr=2e-3, epochs=125, save_name="windowed", weight_decay=1e-4)
    torch.save(model.state_dict(), "model_windowed.pth")
